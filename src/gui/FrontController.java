...
public class FrontController implements Initializable {
    ...
    @FXML
    private void ajouterLivraison(ActionEvent event) throws IOException, TesseractException {
        ...
        if (tfMethod.getText().isEmpty() || tfAdresse.getText().isEmpty() || tfIdClient.getText().isEmpty() || tfIdProd.getText().isEmpty()) {
            ...
            try {
                ...
                String te = tesseract.doOCR(new File("C:\\Users\\MSI\\Documents\\NetBeansProjects\\DesktopFXMLPiDev\\src" + s));
                System.out.print(te);
