...
public class LoginController implements Initializable {
    ...
    private void checkLogin(ActionEvent event) throws IOException {
        ...
        if (username.getText().toString().equals("dhia") && password.getText().toString().equals("dhia")) {
            ...
            stage.setScene(scene);
            stage.show();
        }else if (username.getText().toString().equals("nabil") && password.getText().toString().equals("nabil")) {
            error.setText("Success!");
            ...
            stage.setScene(scene);
            stage.show();
        }else if (username.getText().toString().equals("nabil") && password.getText().toString().equals("back")) {
            error.setText("Success!");
            ...
            root = FXMLLoader.load(getClass().getResource("/gui/GestLivreur.fxml"));
            stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
            scene = new Scene(root);
            stage.setScene(scene);
            stage.show();
