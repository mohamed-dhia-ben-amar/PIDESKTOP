 ...
 * @author MSI
 */
public class SupprimertournoibackController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ObservableList<tournoi> tournois = FXCollections.observableArrayList();
               ...
               // idarticle.setCellValueFactory(new PropertyValueFactory<Article,Integer>("id"));
                name.setCellValueFactory(new PropertyValueFactory<tournoi,String>("name"));
    ...
    private void supprimertournoi(ActionEvent event) throws IOException {
        ...
        int idtournoi = Integer.parseInt(idfield.getText()); 
        
        
        
        
       tournoiCrud t= new tournoiCrud(); 
       t.Supprimertournoi(idtournoi);
